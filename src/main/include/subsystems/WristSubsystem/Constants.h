...
namespace WristConstants {
    ...
    constexpr units::time::second_t kRampSeconds = 0.45_s;
    ...
    constexpr units::angle::degree_t kWristDegreeMin{-180.0_deg};   // encoder Turns at the Floor's minimum usable position
    ...
    constexpr units::angle::degree_t kWristStartAngle{110.0_deg};
    // position deadzone
